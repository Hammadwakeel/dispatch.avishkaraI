        ...
        <ul className="mt-12 grid gap-3 sm:grid-cols-2">
          {resourcesMegaLinks.map((p) => (
            <li key={p.href}>
              <Link
                href={p.href}
                className={`block rounded-[var(--radius-card)] border border-light-steel bg-harvest-cream/70 px-5 py-4 font-sans text-[15px] transition-colors hover:border-amber-glow/40 hover:bg-harvest-cream ${
