...
export function HeroLeadForm() {
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="min-h-[52px] shrink-0 rounded-[var(--radius-ui)] bg-amber-glow px-8 font-sans text-[14px] font-semibold text-canvas-white shadow-[var(--shadow-sm)] hover:brightness-[1.03]"
        style={{ transitionDuration: "var(--transition-interactive)" }}
      >
        Book a demo
      </button>
